                                                          ...
                                                          string[] filters)
    {
        ...
        var options = new EnumerationOptions
                          {
                              ...
                              IgnoreInaccessible = true, // skips most UnauthorizedAccess cases
        ...
        while (true)
        {
            ...
            try
            {
                ...
                e is IOException)
            {
                Log.Warning($"Failed to enumerate resources under '{directory}': {e.Message}");
            ...
            foreach (var filter in filters)
            {
                ...
                if (filter.EndsWith('*') && PathIsShader(fileNameSpan))
                    continue;
